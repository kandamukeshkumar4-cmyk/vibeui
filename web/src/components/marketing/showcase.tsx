    ...
    <section className="overflow-hidden bg-white py-20">
      <div className="mx-auto max-w-6xl px-4">
        ...
        <div className="mb-14 text-center">
          ...
          <p className="mt-2 text-sm text-slate-400">Click any screen to see it full size</p>
        </div>
              ...
              >
                ...
                >
                  ...
                  <div className="absolute inset-0 rounded-3xl opacity-0 group-hover:opacity-100 transition-opacity duration-200 flex items-center justify-center"
                    style={{ background: "rgba(99,102,241,0.12)", border: "2px solid rgba(99,102,241,0.5)" }}>
                ...
                <div className="mt-8 text-center">
                  <p className="text-xs font-semibold text-slate-700">{app.label}</p>
        ...
        <div className="mt-2 flex flex-wrap items-center justify-center gap-3">
          {apps.map((app) => (
            <span key={app.id} className="rounded-full border border-slate-200 bg-slate-50 px-4 py-1.5 text-xs font-medium text-slate-600">
              {app.category}
            </span>
          ))}
        </div>
